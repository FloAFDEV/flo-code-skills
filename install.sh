...
if [[ ${#SELECTED[@]} -eq 0 ]]; then
  SELECTED=(flo-project-audit flo-dev-standards flo-debug flo-medical flo-nextjs flo-supabase flo-offline flo-seo frontend-design flo-ui design-taste playwright)
fi
